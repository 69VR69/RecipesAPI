import Joi from 'joi';
import { RecipeWhereInputSchemaObject, RecipeOrderByWithAggregationInputSchemaObject, RecipeScalarWhereWithAggregatesInputSchemaObject } from './objects/index.js/index.js';
